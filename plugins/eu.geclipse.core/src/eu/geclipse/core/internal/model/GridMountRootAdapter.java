...
public class GridMountRootAdapter
    extends GridMountFolderAdapter
    implements IFile, IFolder {

  GridMountRootAdapter( final GridMount gridMount ) {
    super( gridMount );
  }
  
  public IFile getFsFile() {
    return getGridMount().getFsFile();
  }
  ...
  public String getFileExtension() {
    return getFsFile().getFileExtension();
  }
  ...
  public boolean isSynchronized( final int depth ) {
    return getFsFile().isSynchronized( depth );
  }
