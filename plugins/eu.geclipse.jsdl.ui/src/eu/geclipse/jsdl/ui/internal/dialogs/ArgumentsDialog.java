...
public class ArgumentsDialog extends Dialog {
  ...
  protected Control createDialogArea( final Composite parent ) {
    ...
    this.lblFileSystemName.setText( Messages.getString( "JobApplicationPage_FileSystemName" ) ); //$NON-NLS-1$
...
//      this.txtFileSystemName.setText( this.fileSystemType.getName() );
    ...
    EList<FileSystemType> fileSystemList;
    ...
    this.lblValue.setText( Messages.getString( "JobApplicationPage_Value" ) ); //$NON-NLS-1$
    ...
    /* Initial Values for Edit Operation */
    if ( this.editMode ) {
      this.txtValue.setText( this.fileSystemType.getName() );
    }
...
//      this.argumentType = new ArgumentType[1];
