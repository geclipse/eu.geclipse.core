  ...
  protected T doSwitch( int classifierID, EObject theEObject ) {
    switch( classifierID ) {
      case IWorkflowPackage.IPORT: {
        ...
        if( result == null )
          result = caseIWorkflowElement( iPort );
        if( result == null )
      ...
      case IWorkflowPackage.ILINK: {
        ...
        if( result == null )
          result = caseIWorkflowElement( iLink );
        if( result == null )
          result = defaultCase( theEObject );
        return result;
      }
      case IWorkflowPackage.IINPUT_PORT: {
        ...
        if( result == null )
          result = caseIPort( iInputPort );
        if( result == null )
          result = caseIWorkflowElement( iInputPort );
        if( result == null )
          result = defaultCase( theEObject );
        return result;
      }
      case IWorkflowPackage.IOUTPUT_PORT: {
        ...
        if( result == null )
          result = caseIPort( iOutputPort );
        if( result == null )
          result = caseIWorkflowElement( iOutputPort );
        if( result == null )
          result = defaultCase( theEObject );
        return result;
      }
      case IWorkflowPackage.IWORKFLOW: {
        ...
        if( result == null )
          result = caseIWorkflowElement( iWorkflow );
        if( result == null )
          result = defaultCase( theEObject );
        return result;
      }
      case IWorkflowPackage.IWORKFLOW_JOB: {
        ...
        if( result == null )
          result = caseIWorkflowNode( iWorkflowJob );
        if( result == null )
          result = caseIWorkflowElement( iWorkflowJob );
        if( result == null )
          result = defaultCase( theEObject );
        return result;
      }
      ...
      case IWorkflowPackage.IWORKFLOW_NODE: {
        ...
        if( result == null )
          result = caseIWorkflowElement( iWorkflowNode );
        if( result == null )
          result = defaultCase( theEObject );
        return result;
      }
