...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>IWorkflow Element</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public abstract class WorkflowElementImpl extends EObjectImpl
  implements IWorkflowElement
{
  ...
  public void setName( String newName ) {
    ...
    if( eNotificationRequired() )
      eNotify( new ENotificationImpl( this,
                                      Notification.SET,
                                      IWorkflowPackage.IWORKFLOW_ELEMENT__NAME,
                                      oldName,
                                      this.name ) );
  }

  /**
   * <!-- begin-user-doc --> This method generates and caches an id as and when
   * required. <!-- end-user-doc -->
   */
  public String getId() {
    if( this.id == null ) {
      this.id = generateId();
  ...
  /**
   * <!-- begin-user-doc --> This method sets an id. <!-- end-user-doc -->
   */
  public void setId( String newId ) {
    ...
    if( eNotificationRequired() )
      eNotify( new ENotificationImpl( this,
                                      Notification.SET,
                                      IWorkflowPackage.IWORKFLOW_ELEMENT__ID,
                                      oldId,
                                      this.id ) );
  }
    ...
    switch( featureID ) {
      case IWorkflowPackage.IWORKFLOW_ELEMENT__NAME:
        return NAME_EDEFAULT == null
                                    ? this.name != null
                                    : !NAME_EDEFAULT.equals( this.name );
      case IWorkflowPackage.IWORKFLOW_ELEMENT__ID:
