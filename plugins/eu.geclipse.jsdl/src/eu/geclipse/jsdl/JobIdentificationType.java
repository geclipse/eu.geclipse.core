 ...
 * </copyright>
 *
 * $Id: JobIdentificationType.java,v 1.1 2007/01/25 15:26:29 emstamou Exp $
 */
 ...
 * <ul>
 *   <li>{@link eu.geclipse.jsdl.JobIdentificationType#getJobName <em>Job Name</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.JobIdentificationType#getDescription <em>Description</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.JobIdentificationType#getJobAnnotation <em>Job Annotation</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.JobIdentificationType#getJobProject <em>Job Project</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.JobIdentificationType#getAny <em>Any</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.JobIdentificationType#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.geclipse.jsdl.JsdlPackage#getJobIdentificationType()
...
public interface JobIdentificationType extends EObject {
	 ...
	 * @see eu.geclipse.jsdl.JsdlPackage#getJobIdentificationType_JobName()
	...
	/**
	 * Sets the value of the '{@link eu.geclipse.jsdl.JobIdentificationType#getJobName <em>Job Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see eu.geclipse.jsdl.JsdlPackage#getJobIdentificationType_Description()
	...
	/**
	 * Sets the value of the '{@link eu.geclipse.jsdl.JobIdentificationType#getDescription <em>Description</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see eu.geclipse.jsdl.JsdlPackage#getJobIdentificationType_JobAnnotation()
	 ...
	 * @see eu.geclipse.jsdl.JsdlPackage#getJobIdentificationType_JobProject()
	 * @model type="java.lang.String" unique="false" dataType="org.eclipse.emf.ecore.xml.type.String"
	 ...
	 * @see eu.geclipse.jsdl.JsdlPackage#getJobIdentificationType_Any()
	 ...
	 * @see eu.geclipse.jsdl.JsdlPackage#getJobIdentificationType_AnyAttribute()
	 * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry" many="true"
