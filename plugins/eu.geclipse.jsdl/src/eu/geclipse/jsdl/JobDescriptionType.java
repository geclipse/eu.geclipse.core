 ...
 * </copyright>
 *
 * $Id: JobDescriptionType.java,v 1.1 2007/01/25 15:26:28 emstamou Exp $
 */
 ...
 * <ul>
 *   <li>{@link eu.geclipse.jsdl.JobDescriptionType#getJobIdentification <em>Job Identification</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.JobDescriptionType#getApplication <em>Application</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.JobDescriptionType#getResources <em>Resources</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.JobDescriptionType#getDataStaging <em>Data Staging</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.JobDescriptionType#getAny <em>Any</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.JobDescriptionType#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.geclipse.jsdl.JsdlPackage#getJobDescriptionType()
...
public interface JobDescriptionType extends EObject {
	 ...
	 * @see eu.geclipse.jsdl.JsdlPackage#getJobDescriptionType_JobIdentification()
	...
	/**
	 * Sets the value of the '{@link eu.geclipse.jsdl.JobDescriptionType#getJobIdentification <em>Job Identification</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see eu.geclipse.jsdl.JsdlPackage#getJobDescriptionType_Application()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link eu.geclipse.jsdl.JobDescriptionType#getApplication <em>Application</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see eu.geclipse.jsdl.JsdlPackage#getJobDescriptionType_Resources()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link eu.geclipse.jsdl.JobDescriptionType#getResources <em>Resources</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link eu.geclipse.jsdl.DataStagingType}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see eu.geclipse.jsdl.JsdlPackage#getJobDescriptionType_DataStaging()
	 * @model type="eu.geclipse.jsdl.DataStagingType" containment="true"
	 ...
	 * @see eu.geclipse.jsdl.JsdlPackage#getJobDescriptionType_Any()
	 ...
	 * @see eu.geclipse.jsdl.JsdlPackage#getJobDescriptionType_AnyAttribute()
	 * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry" many="true"
