 ...
 * </copyright>
 *
 * $Id: POSIXApplicationTypeImpl.java,v 1.1 2007/01/25 15:26:29 emstamou Exp $
 */
 ...
 * <ul>
 *   <li>{@link eu.geclipse.jsdl.posix.impl.POSIXApplicationTypeImpl#getExecutable <em>Executable</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.posix.impl.POSIXApplicationTypeImpl#getArgument <em>Argument</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.posix.impl.POSIXApplicationTypeImpl#getInput <em>Input</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.posix.impl.POSIXApplicationTypeImpl#getOutput <em>Output</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.posix.impl.POSIXApplicationTypeImpl#getError <em>Error</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.posix.impl.POSIXApplicationTypeImpl#getWorkingDirectory <em>Working Directory</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.posix.impl.POSIXApplicationTypeImpl#getEnvironment <em>Environment</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.posix.impl.POSIXApplicationTypeImpl#getWallTimeLimit <em>Wall Time Limit</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.posix.impl.POSIXApplicationTypeImpl#getFileSizeLimit <em>File Size Limit</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.posix.impl.POSIXApplicationTypeImpl#getCoreDumpLimit <em>Core Dump Limit</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.posix.impl.POSIXApplicationTypeImpl#getDataSegmentLimit <em>Data Segment Limit</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.posix.impl.POSIXApplicationTypeImpl#getLockedMemoryLimit <em>Locked Memory Limit</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.posix.impl.POSIXApplicationTypeImpl#getMemoryLimit <em>Memory Limit</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.posix.impl.POSIXApplicationTypeImpl#getOpenDescriptorsLimit <em>Open Descriptors Limit</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.posix.impl.POSIXApplicationTypeImpl#getPipeSizeLimit <em>Pipe Size Limit</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.posix.impl.POSIXApplicationTypeImpl#getStackSizeLimit <em>Stack Size Limit</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.posix.impl.POSIXApplicationTypeImpl#getCPUTimeLimit <em>CPU Time Limit</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.posix.impl.POSIXApplicationTypeImpl#getProcessCountLimit <em>Process Count Limit</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.posix.impl.POSIXApplicationTypeImpl#getVirtualMemoryLimit <em>Virtual Memory Limit</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.posix.impl.POSIXApplicationTypeImpl#getThreadCountLimit <em>Thread Count Limit</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.posix.impl.POSIXApplicationTypeImpl#getUserName <em>User Name</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.posix.impl.POSIXApplicationTypeImpl#getGroupName <em>Group Name</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.posix.impl.POSIXApplicationTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.posix.impl.POSIXApplicationTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
