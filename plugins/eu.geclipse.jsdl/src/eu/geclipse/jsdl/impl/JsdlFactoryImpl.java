 ...
 * </copyright>
 *
 * $Id: JsdlFactoryImpl.java,v 1.1 2007/01/25 15:26:30 emstamou Exp $
 */
...
public class JsdlFactoryImpl extends EFactoryImpl implements JsdlFactory {
	...
	public static JsdlFactory init() {
		try {
			JsdlFactory theJsdlFactory = (JsdlFactory)EPackage.Registry.INSTANCE.getEFactory("http://eu/geclipse/jsdl"); 
