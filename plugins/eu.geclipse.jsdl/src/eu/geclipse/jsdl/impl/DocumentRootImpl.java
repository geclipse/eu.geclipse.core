 ...
 * </copyright>
 *
 * $Id: DocumentRootImpl.java,v 1.1 2007/01/25 15:26:29 emstamou Exp $
 */
 ...
 * <ul>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getApplication <em>Application</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getApplicationName <em>Application Name</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getApplicationVersion <em>Application Version</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getCandidateHosts <em>Candidate Hosts</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getCPUArchitecture <em>CPU Architecture</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getCPUArchitectureName <em>CPU Architecture Name</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getCreationFlag <em>Creation Flag</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getDataStaging <em>Data Staging</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#isDeleteOnTermination <em>Delete On Termination</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getDiskSpace <em>Disk Space</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#isExclusiveExecution <em>Exclusive Execution</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getFileName <em>File Name</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getFileSystem <em>File System</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getFilesystemName <em>Filesystem Name</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getFileSystemType <em>File System Type</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getHostName <em>Host Name</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getIndividualCPUCount <em>Individual CPU Count</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getIndividualCPUSpeed <em>Individual CPU Speed</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getIndividualCPUTime <em>Individual CPU Time</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getIndividualDiskSpace <em>Individual Disk Space</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getIndividualNetworkBandwidth <em>Individual Network Bandwidth</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getIndividualPhysicalMemory <em>Individual Physical Memory</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getIndividualVirtualMemory <em>Individual Virtual Memory</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getJobAnnotation <em>Job Annotation</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getJobDefinition <em>Job Definition</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getJobDescription <em>Job Description</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getJobIdentification <em>Job Identification</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getJobName <em>Job Name</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getJobProject <em>Job Project</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getMountPoint <em>Mount Point</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getOperatingSystem <em>Operating System</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getOperatingSystemName <em>Operating System Name</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getOperatingSystemType <em>Operating System Type</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getOperatingSystemVersion <em>Operating System Version</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getResources <em>Resources</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getSource <em>Source</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getTotalCPUCount <em>Total CPU Count</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getTotalCPUTime <em>Total CPU Time</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getTotalDiskSpace <em>Total Disk Space</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getTotalPhysicalMemory <em>Total Physical Memory</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getTotalResourceCount <em>Total Resource Count</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getTotalVirtualMemory <em>Total Virtual Memory</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DocumentRootImpl#getURI <em>URI</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
