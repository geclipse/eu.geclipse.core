 ...
 * </copyright>
 *
 * $Id: DataStagingTypeImpl.java,v 1.1 2007/01/25 15:26:30 emstamou Exp $
 */
 ...
 * <ul>
 *   <li>{@link eu.geclipse.jsdl.impl.DataStagingTypeImpl#getFileName <em>File Name</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DataStagingTypeImpl#getFilesystemName <em>Filesystem Name</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DataStagingTypeImpl#getCreationFlag <em>Creation Flag</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DataStagingTypeImpl#isDeleteOnTermination <em>Delete On Termination</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DataStagingTypeImpl#getSource <em>Source</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DataStagingTypeImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DataStagingTypeImpl#getAny <em>Any</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DataStagingTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.impl.DataStagingTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
