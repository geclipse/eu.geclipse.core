 ...
 * </copyright>
 *
 * $Id: OperatingSystemTypeItemProvider.java,v 1.1 2007/01/25 15:29:06 emstamou Exp $
 */
...
/**
 * This is the item provider adapter for a {@link eu.geclipse.jsdl.OperatingSystemType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OperatingSystemTypeItemProvider
	 ...
	 * @generated
	 */
	public OperatingSystemTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OperatingSystemType_operatingSystemVersion_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OperatingSystemType_operatingSystemVersion_feature", "_UI_OperatingSystemType_type"),
				 JsdlPackage.Literals.OPERATING_SYSTEM_TYPE__OPERATING_SYSTEM_VERSION,
				 true,
				 false,
				 false,
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OperatingSystemType_description_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OperatingSystemType_description_feature", "_UI_OperatingSystemType_type"),
				 JsdlPackage.Literals.OPERATING_SYSTEM_TYPE__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(JsdlPackage.Literals.OPERATING_SYSTEM_TYPE__OPERATING_SYSTEM_TYPE);
			childrenFeatures.add(JsdlPackage.Literals.OPERATING_SYSTEM_TYPE__ANY);
			childrenFeatures.add(JsdlPackage.Literals.OPERATING_SYSTEM_TYPE__ANY_ATTRIBUTE);
		}
	...
	/**
	 * This returns OperatingSystemType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/OperatingSystemType"));
	}
	...
	public String getText(Object object) {
		String label = ((OperatingSystemType)object).getOperatingSystemVersion();
		return label == null || label.length() == 0 ?
			getString("_UI_OperatingSystemType_type") :
			getString("_UI_OperatingSystemType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(OperatingSystemType.class)) {
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(JsdlPackage.Literals.OPERATING_SYSTEM_TYPE__OPERATING_SYSTEM_TYPE,
				 JsdlFactory.eINSTANCE.createOperatingSystemTypeType()));

		newChildDescriptors.add
			(createChildParameter
				(JsdlPackage.Literals.OPERATING_SYSTEM_TYPE__ANY,
