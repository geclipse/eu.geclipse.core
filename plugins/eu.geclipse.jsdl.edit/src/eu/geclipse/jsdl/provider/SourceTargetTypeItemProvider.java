 ...
 * </copyright>
 *
 * $Id: SourceTargetTypeItemProvider.java,v 1.1 2007/01/25 15:29:06 emstamou Exp $
 */
...
/**
 * This is the item provider adapter for a {@link eu.geclipse.jsdl.SourceTargetType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SourceTargetTypeItemProvider
	 ...
	 * @generated
	 */
	public SourceTargetTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SourceTargetType_uRI_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SourceTargetType_uRI_feature", "_UI_SourceTargetType_type"),
				 JsdlPackage.Literals.SOURCE_TARGET_TYPE__URI,
				 true,
				 false,
				 false,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(JsdlPackage.Literals.SOURCE_TARGET_TYPE__ANY);
			childrenFeatures.add(JsdlPackage.Literals.SOURCE_TARGET_TYPE__ANY_ATTRIBUTE);
		}
	...
	/**
	 * This returns SourceTargetType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SourceTargetType"));
	}
	...
	public String getText(Object object) {
		String label = ((SourceTargetType)object).getURI();
		return label == null || label.length() == 0 ?
			getString("_UI_SourceTargetType_type") :
			getString("_UI_SourceTargetType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SourceTargetType.class)) {
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(JsdlPackage.Literals.SOURCE_TARGET_TYPE__ANY,
