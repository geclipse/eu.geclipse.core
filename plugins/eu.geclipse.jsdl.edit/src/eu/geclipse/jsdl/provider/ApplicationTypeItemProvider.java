 ...
 * </copyright>
 *
 * $Id: ApplicationTypeItemProvider.java,v 1.1 2007/01/25 15:29:05 emstamou Exp $
 */
...
/**
 * This is the item provider adapter for a {@link eu.geclipse.jsdl.ApplicationType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ApplicationTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 JsdlPackage.Literals.APPLICATION_TYPE__APPLICATION_NAME,
				 true,
				 false,
				 false,
	...
	protected void addApplicationVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ApplicationType_applicationVersion_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ApplicationType_applicationVersion_feature", "_UI_ApplicationType_type"),
				 JsdlPackage.Literals.APPLICATION_TYPE__APPLICATION_VERSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ApplicationType_description_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ApplicationType_description_feature", "_UI_ApplicationType_type"),
				 JsdlPackage.Literals.APPLICATION_TYPE__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(JsdlPackage.Literals.APPLICATION_TYPE__ANY);
			childrenFeatures.add(JsdlPackage.Literals.APPLICATION_TYPE__ANY_ATTRIBUTE);
		}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(JsdlPackage.Literals.APPLICATION_TYPE__ANY,
