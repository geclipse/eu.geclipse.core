 ...
 * </copyright>
 *
 * $Id: JobIdentificationTypeItemProvider.java,v 1.1 2007/01/25 15:29:05 emstamou Exp $
 */
...
/**
 * This is the item provider adapter for a {@link eu.geclipse.jsdl.JobIdentificationType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class JobIdentificationTypeItemProvider
	 ...
	 * @generated
	 */
	public JobIdentificationTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_JobIdentificationType_jobName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_JobIdentificationType_jobName_feature", "_UI_JobIdentificationType_type"),
				 JsdlPackage.Literals.JOB_IDENTIFICATION_TYPE__JOB_NAME,
				 true,
				 false,
				 false,
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_JobIdentificationType_description_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_JobIdentificationType_description_feature", "_UI_JobIdentificationType_type"),
				 JsdlPackage.Literals.JOB_IDENTIFICATION_TYPE__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addJobAnnotationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_JobIdentificationType_jobAnnotation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_JobIdentificationType_jobAnnotation_feature", "_UI_JobIdentificationType_type"),
				 JsdlPackage.Literals.JOB_IDENTIFICATION_TYPE__JOB_ANNOTATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addJobProjectPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_JobIdentificationType_jobProject_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_JobIdentificationType_jobProject_feature", "_UI_JobIdentificationType_type"),
				 JsdlPackage.Literals.JOB_IDENTIFICATION_TYPE__JOB_PROJECT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(JsdlPackage.Literals.JOB_IDENTIFICATION_TYPE__ANY);
			childrenFeatures.add(JsdlPackage.Literals.JOB_IDENTIFICATION_TYPE__ANY_ATTRIBUTE);
		}
	...
	/**
	 * This returns JobIdentificationType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/JobIdentificationType"));
	}
	...
	public String getText(Object object) {
		String label = ((JobIdentificationType)object).getJobName();
		return label == null || label.length() == 0 ?
			getString("_UI_JobIdentificationType_type") :
			getString("_UI_JobIdentificationType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(JobIdentificationType.class)) {
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(JsdlPackage.Literals.JOB_IDENTIFICATION_TYPE__ANY,
