 ...
 * interfacing with the AWS EC2 Service.
 * 
 * @author Moritz Post
 */
public class EC2ProblemException extends ProblemException {

  /**
   * Create a new {@link EC2ProblemException} for the problem with the specified ID.
   * 
   ...
   */
  public EC2ProblemException( final String problemID,
