...
/**
 * The separation of graphical UI elements from the core implementation 
 * forced the introduction of this interface. It is support by an extension point
 * which will be consumed by the UI components of the SLA core. 
 * 
 * @author korn
 */
public interface ISLAServiceSelector {
