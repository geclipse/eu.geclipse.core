...
public class GridJobDetailsFactory implements IJobDetailsFactory {
   ...
   * (non-Javadoc)
   * 
   * @see eu.geclipse.ui.views.jobdetailsNEW.IJobDetailsFactory#getDetails(eu.geclipse.core.model.IGridJob,
   *      eu.geclipse.ui.views.jobdetailsNEW.JobDetailSectionsManager)
   */
