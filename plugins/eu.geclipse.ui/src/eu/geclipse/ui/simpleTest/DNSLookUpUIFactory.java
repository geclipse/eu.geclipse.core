 ...
 *
 */
public class DNSLookUpUIFactory extends AbstractSimpleTestUIFactory {

  public AbstractSimpleTestDialog getSimpleTestDialog( final ISimpleTest test, 
                                                       final List< IGridResource > resources, 
                                                       final Shell parentShell ) {
    DNSLookUpDialog dialog = new DNSLookUpDialog( resources, parentShell );
    return dialog;
  }
  ...
  public ISimpleTestDescription getSupportedDescription() {
    return new DNSLookUpDescription();
  }
