 ...
 *
 */
public class PortScanDescription implements ISimpleTestDescription {
  ...
  public String getSimpleTestTypeName() {
    return Messages.getString( "PortScanDescription.testTypeName" ); //$NON-NLS-1$
  }
  ...
  public boolean matches( final ISimpleTestDescription otherTest ) {
    ...
    if ( otherTest instanceof PortScanDescription ) {
      result = true;
    }
