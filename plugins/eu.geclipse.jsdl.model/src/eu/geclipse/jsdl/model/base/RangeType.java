 ...
 * <ul>
 *   <li>{@link eu.geclipse.jsdl.model.base.RangeType#getLowerBound <em>Lower Bound</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.model.base.RangeType#getUpperBound <em>Upper Bound</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.model.base.RangeType#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.geclipse.jsdl.model.base.JsdlPackage#getRangeType()
...
public interface RangeType extends EObject
{
   ...
   * @see eu.geclipse.jsdl.model.base.JsdlPackage#getRangeType_LowerBound()
  ...
  /**
   * Sets the value of the '{@link eu.geclipse.jsdl.model.base.RangeType#getLowerBound <em>Lower Bound</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see eu.geclipse.jsdl.model.base.JsdlPackage#getRangeType_UpperBound()
   * @model containment="true" required="true"
  ...
  /**
   * Sets the value of the '{@link eu.geclipse.jsdl.model.base.RangeType#getUpperBound <em>Upper Bound</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see eu.geclipse.jsdl.model.base.JsdlPackage#getRangeType_AnyAttribute()
