 ...
 * <ul>
 *   <li>{@link eu.geclipse.jsdl.model.base.JobDescriptionType#getJobIdentification <em>Job Identification</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.model.base.JobDescriptionType#getApplication <em>Application</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.model.base.JobDescriptionType#getResources <em>Resources</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.model.base.JobDescriptionType#getDataStaging <em>Data Staging</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.model.base.JobDescriptionType#getAny <em>Any</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.model.base.JobDescriptionType#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.geclipse.jsdl.model.base.JsdlPackage#getJobDescriptionType()
...
public interface JobDescriptionType extends EObject
{
   ...
   * @see eu.geclipse.jsdl.model.base.JsdlPackage#getJobDescriptionType_JobIdentification()
  ...
  /**
   * Sets the value of the '{@link eu.geclipse.jsdl.model.base.JobDescriptionType#getJobIdentification <em>Job Identification</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see eu.geclipse.jsdl.model.base.JsdlPackage#getJobDescriptionType_Application()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link eu.geclipse.jsdl.model.base.JobDescriptionType#getApplication <em>Application</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see eu.geclipse.jsdl.model.base.JsdlPackage#getJobDescriptionType_Resources()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link eu.geclipse.jsdl.model.base.JobDescriptionType#getResources <em>Resources</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The list contents are of type {@link eu.geclipse.jsdl.model.base.DataStagingType}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see eu.geclipse.jsdl.model.base.JsdlPackage#getJobDescriptionType_DataStaging()
   * @model type="eu.geclipse.jsdl.model.base.DataStagingType" containment="true"
   ...
   * @see eu.geclipse.jsdl.model.base.JsdlPackage#getJobDescriptionType_Any()
   ...
   * @see eu.geclipse.jsdl.model.base.JsdlPackage#getJobDescriptionType_AnyAttribute()
   * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry" many="true"
