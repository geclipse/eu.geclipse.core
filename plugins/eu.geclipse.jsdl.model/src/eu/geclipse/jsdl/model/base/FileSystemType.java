 ...
 * <ul>
 *   <li>{@link eu.geclipse.jsdl.model.base.FileSystemType#getFileSystemType <em>File System Type</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.model.base.FileSystemType#getDescription <em>Description</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.model.base.FileSystemType#getMountPoint <em>Mount Point</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.model.base.FileSystemType#getDiskSpace <em>Disk Space</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.model.base.FileSystemType#getAny <em>Any</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.model.base.FileSystemType#getName <em>Name</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.model.base.FileSystemType#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.geclipse.jsdl.model.base.JsdlPackage#getFileSystemType()
...
public interface FileSystemType extends EObject
{
   ...
   * @see eu.geclipse.jsdl.model.base.JsdlPackage#getFileSystemType_FileSystemType()
  ...
  /**
   * Sets the value of the '{@link eu.geclipse.jsdl.model.base.FileSystemType#getFileSystemType <em>File System Type</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Unsets the value of the '{@link eu.geclipse.jsdl.model.base.FileSystemType#getFileSystemType <em>File System Type</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #isSetFileSystemType()
   * @see #getFileSystemType()
  ...
  /**
   * Returns whether the value of the '{@link eu.geclipse.jsdl.model.base.FileSystemType#getFileSystemType <em>File System Type</em>}' attribute is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see eu.geclipse.jsdl.model.base.JsdlPackage#getFileSystemType_Description()
   * @model unique="false" dataType="eu.geclipse.jsdl.model.base.DescriptionType"
  ...
  /**
   * Sets the value of the '{@link eu.geclipse.jsdl.model.base.FileSystemType#getDescription <em>Description</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see eu.geclipse.jsdl.model.base.JsdlPackage#getFileSystemType_MountPoint()
  ...
  /**
   * Sets the value of the '{@link eu.geclipse.jsdl.model.base.FileSystemType#getMountPoint <em>Mount Point</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see eu.geclipse.jsdl.model.base.JsdlPackage#getFileSystemType_DiskSpace()
  ...
  /**
   * Sets the value of the '{@link eu.geclipse.jsdl.model.base.FileSystemType#getDiskSpace <em>Disk Space</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see eu.geclipse.jsdl.model.base.JsdlPackage#getFileSystemType_Any()
   ...
   * @see #setName(String)
   * @see eu.geclipse.jsdl.model.base.JsdlPackage#getFileSystemType_Name()
  ...
  /**
   * Sets the value of the '{@link eu.geclipse.jsdl.model.base.FileSystemType#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see eu.geclipse.jsdl.model.base.JsdlPackage#getFileSystemType_AnyAttribute()
   * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry" many="true"
