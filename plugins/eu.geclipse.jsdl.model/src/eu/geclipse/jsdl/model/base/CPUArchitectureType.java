 ...
 * <ul>
 *   <li>{@link eu.geclipse.jsdl.model.base.CPUArchitectureType#getCPUArchitectureName <em>CPU Architecture Name</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.model.base.CPUArchitectureType#getAny <em>Any</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.model.base.CPUArchitectureType#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.geclipse.jsdl.model.base.JsdlPackage#getCPUArchitectureType()
...
public interface CPUArchitectureType extends EObject
{
   ...
   * @see eu.geclipse.jsdl.model.base.JsdlPackage#getCPUArchitectureType_CPUArchitectureName()
  ...
  /**
   * Sets the value of the '{@link eu.geclipse.jsdl.model.base.CPUArchitectureType#getCPUArchitectureName <em>CPU Architecture Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Unsets the value of the '{@link eu.geclipse.jsdl.model.base.CPUArchitectureType#getCPUArchitectureName <em>CPU Architecture Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #isSetCPUArchitectureName()
   * @see #getCPUArchitectureName()
  ...
  /**
   * Returns whether the value of the '{@link eu.geclipse.jsdl.model.base.CPUArchitectureType#getCPUArchitectureName <em>CPU Architecture Name</em>}' attribute is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see eu.geclipse.jsdl.model.base.JsdlPackage#getCPUArchitectureType_Any()
   ...
   * @see eu.geclipse.jsdl.model.base.JsdlPackage#getCPUArchitectureType_AnyAttribute()
   * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry" many="true"
