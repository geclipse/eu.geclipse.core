 ...
 * <ul>
 *   <li>{@link eu.geclipse.jsdl.model.SourceTargetType#getURI <em>URI</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.model.SourceTargetType#getAny <em>Any</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.model.SourceTargetType#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.geclipse.jsdl.model.JsdlPackage#getSourceTargetType()
...
public interface SourceTargetType extends EObject
{
   ...
   * @see #setURI(String)
   * @see eu.geclipse.jsdl.model.JsdlPackage#getSourceTargetType_URI()
  ...
  /**
   * Sets the value of the '{@link eu.geclipse.jsdl.model.SourceTargetType#getURI <em>URI</em>}' attribute.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   ...
   * @see eu.geclipse.jsdl.model.JsdlPackage#getSourceTargetType_Any()
   ...
   * @see eu.geclipse.jsdl.model.JsdlPackage#getSourceTargetType_AnyAttribute()
   * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry" many="true"
