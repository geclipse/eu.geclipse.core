 ...
 * <ul>
 *   <li>{@link eu.geclipse.jsdl.model.JobDefinitionType#getJobDescription <em>Job Description</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.model.JobDefinitionType#getAny <em>Any</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.model.JobDefinitionType#getId <em>Id</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.model.JobDefinitionType#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.geclipse.jsdl.model.JsdlPackage#getJobDefinitionType()
...
public interface JobDefinitionType extends EObject
{
   ...
   * @see eu.geclipse.jsdl.model.JsdlPackage#getJobDefinitionType_JobDescription()
  ...
  /**
   * Sets the value of the '{@link eu.geclipse.jsdl.model.JobDefinitionType#getJobDescription <em>Job Description</em>}' containment reference.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   ...
   * @see eu.geclipse.jsdl.model.JsdlPackage#getJobDefinitionType_Any()
   ...
   * @see #setId(String)
   * @see eu.geclipse.jsdl.model.JsdlPackage#getJobDefinitionType_Id()
  ...
  /**
   * Sets the value of the '{@link eu.geclipse.jsdl.model.JobDefinitionType#getId <em>Id</em>}' attribute.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   ...
   * @see eu.geclipse.jsdl.model.JsdlPackage#getJobDefinitionType_AnyAttribute()
   * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry" many="true"
