 ...
 * <ul>
 *   <li>{@link eu.geclipse.jsdl.model.CPUArchitectureType#getCPUArchitectureName <em>CPU Architecture Name</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.model.CPUArchitectureType#getAny <em>Any</em>}</li>
 *   <li>{@link eu.geclipse.jsdl.model.CPUArchitectureType#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
...
public interface CPUArchitectureType extends EObject
{
   ...
   * @see eu.geclipse.jsdl.model.JsdlPackage#getCPUArchitectureType_CPUArchitectureName()
  ...
  /**
   * Sets the value of the '{@link eu.geclipse.jsdl.model.CPUArchitectureType#getCPUArchitectureName <em>CPU Architecture Name</em>}' attribute.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
  ...
  /**
   * Unsets the value of the '{@link eu.geclipse.jsdl.model.CPUArchitectureType#getCPUArchitectureName <em>CPU Architecture Name</em>}' attribute.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   * @see #isSetCPUArchitectureName()
   * @see #getCPUArchitectureName()
  ...
  /**
   * Returns whether the value of the '{@link eu.geclipse.jsdl.model.CPUArchitectureType#getCPUArchitectureName <em>CPU Architecture Name</em>}' attribute is set.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   ...
   * @see eu.geclipse.jsdl.model.JsdlPackage#getCPUArchitectureType_Any()
   ...
   * @see eu.geclipse.jsdl.model.JsdlPackage#getCPUArchitectureType_AnyAttribute()
   * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry" many="true"
