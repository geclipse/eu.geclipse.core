...
import eu.geclipse.core.sla.ISLAServiceSelector;
 ...
 * @author korn
 */
public class SlaServiceSelector implements ISLAServiceSelector {
  ...
  public Object[] selectSLAImplementation() {
    ...
    listdialog.setContentProvider( new SlaServiceContentProvider() );
    listdialog.setLabelProvider( new SlaServiceLabelProvider() );
    listdialog.setInput( eu.geclipse.core.sla.Extensions.getRegisteredSlaServiceNames()
      .toArray() );
