...
/**
 * The class that connects the Figure and Model of the WorkflowJobDescription.
 */
public class WorkflowJobDescriptionEditPart extends CompartmentEditPart
...
//  }
  ...
  protected String getLabelText() {
    String text = null;
    if( getParser() != null ) {
      text = getParser().getPrintString( new EObjectAdapter( getParserElement() ),
      ...
      public String isValid( final Object value ) {
        if( value instanceof String ) {
          ...
          try {
            ...
            return valid.getCode() == ParserEditStatus.EDITABLE
                                                               ? null
                                                               : valid.getMessage();
