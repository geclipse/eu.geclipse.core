...
public class GetJobDescriptionFromFileAction implements IObjectActionDelegate {
  ...
  /**
   * Fires up a GridFileDialog and fetches the contents of a user-chosen JSDL file.  
   */
  public void run( IAction action ) {
    ...
    GridFileDialog dialog = new GridFileDialog( myShell, GridFileDialog.STYLE_ALLOW_ONLY_LOCAL | GridFileDialog.STYLE_ALLOW_ONLY_EXISTING );
...
//    }
  ...
  public void selectionChanged( IAction action, ISelection selection ) {
    ...
    if( selection instanceof IStructuredSelection ) {
      ...
      if( structuredSelection.size() == 1 && structuredSelection.getFirstElement() instanceof WorkflowJobEditPart ) {
