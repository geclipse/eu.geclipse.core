...
public class JMXUtilCrawler {
	...
	public void invoke(String endpoint, String objectName, String argument) throws JMXUtilException {
		...
		try {
			...
			CrawlerControllerAgent mbeanProxy = JMX.newMBeanProxy(mbsc,
					mbeanName, CrawlerControllerAgent.class, true);

			// Invoke mbeanName

			mbeanProxy.startCrawlerTask( argument );
