...
public class AWSVoTestUtil {
  ...
  /** A second dummy access Id for the Amazon EC2 services. */
  public static final String AWS_ACCESS_ID_2 = "awsAccessId2"; //$NON-NLS-1$
  ...
  public static AWSVoCreator getAwsVoCreator() {
     ...
     * AWSVoTestUtil.VO_NAME ); } return awsVoCreator;
     */
  }
